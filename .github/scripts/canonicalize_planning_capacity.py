...
replace(
    "docs/01-product-owner-vision.md",
...
# Engineering
replace(
    "docs/04-engineering-tech-lead.md",
...
# AI-first
replace(
    "docs/05-ai-first-development.md",
...
# Backlog state
replace("docs/06-backlog.md", "**Atualizado em:** 18 de agosto de 2026.", "**Atualizado em:** 20 de agosto de 2026.")
replace(
    "docs/06-backlog.md",
...
# AI after deterministic engine
replace("docs/06-backlog.md", "**Depende de:** dados de uso e regras estáveis", "**Depende de:** TASKIT-302, dados de uso e regras estáveis")
replace(
    "docs/06-backlog.md",
...
replace("docs/06-backlog.md", "**Depende de:** TASKIT-702", "**Depende de:** TASKIT-302, TASKIT-306, TASKIT-702")
replace(
    "docs/06-backlog.md",
